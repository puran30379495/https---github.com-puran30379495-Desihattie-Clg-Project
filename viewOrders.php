                     ...
                     <tr>
                            ...
                            <?php
                                if(isset($_GET['delete'])){
                                    ...
                                    if($mail->send()){
                                        $query1 = "SELECT * FROM orderdetails where orderid = $orderid";
                                        $result1 = mysqli_query($con,$query1);
                                        while($row1 = mysqli_fetch_array($result1)){
                                            $orderid = $row1['orderid'];
                                            $name = $row1['name'];
                                            $orderDet = $row1['orderdet'];
                                            $totalAmt = $row1['totalamt'];
                                            $email = $row1['email'];
                                            $address = $row1['address'];
                                            $delivery = $row1['delivery'];
                                            $time = $row1['orderTime'];
                                            $query2 = "INSERT INTO orderhistory (orderid, name, orderDet, totalamt, email, delivery, address, time) VALUES ('$orderid','$name','$orderDet','$totalAmt','$email','$delivery','$address','$time')";
                     ...
                     <tr>
                            ...
                            <td><?php echo $row['time']; ?></td>
                                ...
                                <?php } ?>
                                    ...
                                    <a href="pdf.php" class="btn btn-danger" style="width: 200px; margin-left: 600px; " target="_blank">Invoice History</a>
</div>
