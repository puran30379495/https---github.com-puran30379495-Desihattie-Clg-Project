                        ...
                        <div class="login-col-2">
                            <div class="login-form">
                                <form method="POST">
                                    ...
                                    <div class="row">
                                        <a href="signup.php" type="signup">Click to Signup</a>
                                        <a href="adminLogin.php" type="adminIndex">Login as Admin</a>
                                        <a href="staffLogin.php" type="adminIndex">Login as Staff</a>
                                        <a href="forgetpassword.php" type="forgetpassword">Forget Password?</a>
                                    </div>
                                </form>
                            </div>
                        </div>
